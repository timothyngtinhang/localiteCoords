...
%% Output file names
config.output.extracted_paths = 'step_1_all_extracted_path.csv';
config.output.valid_files = 'step_2_all_valid_files.csv';
config.output.all_files = 'step_3_all_files_with_coord.csv';
config.output.tms_quality_csv = 'Final_TMS_Quality.csv'; % New output for quality results

...
config.utils.run_checkDurationMatch = false; % New: Set to true to run checkDurationMatch.m
config.utils.run_CsvCompareCoords = true; % New: Set to true to run compareCoords.m
